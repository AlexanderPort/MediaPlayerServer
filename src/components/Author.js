      ...
      <Container maxWidth="lg">
        {
          ...
          {articles.map((article) => (
            <Grid item key={article.pk} xs={36} sm={24} md={12}>
              <Preview2 article={{
                pk: article.pk,
                views: article.views,
                likes: article.likes,
        ...
        }
        {
          ...
          {followers.map((follower) => (
            <Grid item key={follower.pk} xs={12}>
              <Card>
                <CardActionArea onClick={() => setRedirect(`/users/${follower.pk}/`)}>
                  <CardHeader
...
<Paper>
      ...
      <Grid container spacing={4}>
          {state.articles.map((article) => (
            <Grid item key={article.pk} maxWidth="lg">
              <Preview2 article={{title: article.title, description: article.description}}></Preview2>
            </Grid>
          ))}
        </Grid>
*/
